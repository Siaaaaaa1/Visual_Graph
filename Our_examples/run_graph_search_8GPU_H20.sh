...
# ================= 核心环境配置 (针对 H20 & Qwen-VL) =================
# 1. 强制关闭 vLLM V1 实验性引擎 (解决断言错误)
export VLLM_USE_V1=1

# 2. 强制使用 XFormers 后端 (解决 Qwen-VL 非标准头维度报错)
...
# ================= 启动命令 =================
# 修正说明：移除了不存在的 actor.model 和 ref.model 参数
# 精度控制完全由 config.yaml 中的 actor_rollout_ref.model.model_kwargs 负责
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='graph_search_qwen3_4b' \
