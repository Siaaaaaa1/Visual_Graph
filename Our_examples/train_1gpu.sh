...
export TOKENIZERS_PARALLELISM=false #export DISABLE_FLASH_ATTN=1
 # ===== 资源与规模（A800 安全配置）===== 
...
\
data.train_files=./gra2img/dataset/pubmed_train_with_all.parquet \
data.val_files=./gra2img/dataset/pubmed_test_with_all.parquet \
...
env.seed=0 \
env.max_steps=5 \
+env.node_text_path=./gra2img/pubmed_text.json \
